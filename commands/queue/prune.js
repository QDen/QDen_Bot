...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!message.member.roles.cache.some(role => role.name === 'Team Coders')) {
            return message.channel.send('**You do not have access to prune the database! Contact a __Team Coder__ for more support.**');
        }
